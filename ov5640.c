...
static struct regval_list sensor_fmt_rgb888_rgb[] = {  
    {0x4300,0x23},  //RGB
};
...
static struct sensor_format_struct {
  ...
  {
    .desc      = "RGB888",
    .mbus_code = V4L2_MBUS_FMT_RGB888_24X1,
    .regs      = sensor_fmt_rgb888_rgb,
    .regs_size = ARRAY_SIZE(sensor_fmt_rgb888_rgb),
    .bpp       = 1,
  }
